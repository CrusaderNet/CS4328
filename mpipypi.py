...
if rank == 0:
    ...
    while process < size and slice < total_slices:
        ...
        process += 1
    finish = MPI.Wtime()
    print("First slices sending time: ", finish-start)
    ...
    print("Receiving & dynamic allocating time: ", finish-start)
    ...
    totalfinish = MPI.Wtime()
    print("Total time: ", totalfinish-totalstart)
    print("Pi is ", 4.0 * pi)
